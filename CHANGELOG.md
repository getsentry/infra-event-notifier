...
- (release) Switch from action-prepare-release to Craft by @BYK in [#20](https://github.com/getsentry/infra-event-notifier/pull/20)
- Pin GitHub Actions to full-length commit SHAs by @joshuarli in [#22](https://github.com/getsentry/infra-event-notifier/pull/22)

### Other

- release: 0.0.11 by @mwarkentin in [#26](https://github.com/getsentry/infra-event-notifier/pull/26)
